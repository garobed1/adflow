      ...
      case (imin) 
        ...
        do j=bcdata(nn)%jcbeg,bcdata(nn)%jcend
          ...
          do i=bcdata(nn)%icbeg,bcdata(nn)%icend
            ...
            temp = w(2, i, j, irho)
            temp0 = rlv(2, i, j)/temp
            nud = (rlvd(2, i, j)-temp0*wd(2, i, j, irho))/temp
            nu = temp0
      ...
      case (imax) 
        ...
        do j=bcdata(nn)%jcbeg,bcdata(nn)%jcend
          ...
          do i=bcdata(nn)%icbeg,bcdata(nn)%icend
            ...
            temp0 = w(il, i, j, irho)
            temp = rlv(jl, i, j)/temp0
            nud = (rlvd(jl, i, j)-temp*wd(il, i, j, irho))/temp0
            nu = temp
            temp0 = one/(rkwbeta1*(d2wall(il, ii, jj)*d2wall(il, ii, jj)&
&             ))
      ...
      case (jmin) 
        ...
        do j=bcdata(nn)%jcbeg,bcdata(nn)%jcend
          ...
          do i=bcdata(nn)%icbeg,bcdata(nn)%icend
            ...
            temp0 = w(i, 2, j, irho)
            temp = rlv(i, 2, j)/temp0
            nud = (rlvd(i, 2, j)-temp*wd(i, 2, j, irho))/temp0
            nu = temp
      ...
      case (jmax) 
        ...
        do j=bcdata(nn)%jcbeg,bcdata(nn)%jcend
          ...
          do i=bcdata(nn)%icbeg,bcdata(nn)%icend
            ...
            temp0 = w(i, jl, j, irho)
            temp = rlv(i, jl, j)/temp0
            nud = (rlvd(i, jl, j)-temp*wd(i, jl, j, irho))/temp0
            nu = temp
            temp0 = one/(rkwbeta1*(d2wall(ii, jl, jj)*d2wall(ii, jl, jj)&
&             ))
      ...
      case (kmin) 
        ...
        do j=bcdata(nn)%jcbeg,bcdata(nn)%jcend
          ...
          do i=bcdata(nn)%icbeg,bcdata(nn)%icend
            ...
            temp0 = w(i, j, 2, irho)
            temp = rlv(i, j, 2)/temp0
            nud = (rlvd(i, j, 2)-temp*wd(i, j, 2, irho))/temp0
            nu = temp
      ...
      case (kmax) 
        ...
        do j=bcdata(nn)%jcbeg,bcdata(nn)%jcend
          ...
          do i=bcdata(nn)%icbeg,bcdata(nn)%icend
            ...
            temp0 = w(i, j, kl, irho)
            temp = rlv(i, j, kl)/temp0
            nud = (rlvd(i, j, kl)-temp*wd(i, j, kl, irho))/temp0
            nu = temp
            temp0 = one/(rkwbeta1*(d2wall(ii, jj, kl)*d2wall(ii, jj, kl)&
&             ))
...
end module turbbcroutines_diff
