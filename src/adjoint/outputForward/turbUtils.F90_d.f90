...
!
    use constants
    use blockpointersiff, only : nx, ny, nz, il, jl, kl, w, si, sj, sk&
...
!
    use constants
    use blockpointersiff, only : nx, ny, nz, il, jl, kl, vol, vold, &
...
!
    use constants
    use blockpointersiff, only : nx, ny, nz, il, jl, kl, vol, sfacei, &
