...
!
    use constants
    use blockpointersiff, only : ie, je, ke, il, jl, kl, w, wd, p, pd,&
...
&   addgridvelocities, sectionid
    use flowvarrefstateiff, only : timeref, timerefd, eddymodel, &
...
! directions.
                pwx1d = (rid-ri*rjd/rj)/rj
                pwx1 = ri/rj
                if (pwx1 .le. 0.0_8 .and. (adis .eq. 0.0_8 .or. adis &
&                   .ne. int(adis))) then
                  rijd = 0.0_8
                else
...
!
    use constants
    use blockpointersiff, only : ie, je, ke, il, jl, kl, w, p, rlv, &
&   rev, radi, radj, radk, si, sj, sk, sfacei, sfacej, sfacek, dtl, &
&   gamma, vol, addgridvelocities, sectionid
    use flowvarrefstateiff, only : timeref, eddymodel, gammainf, &
...
!
    use constants
    use blockpointersiff, only : il, jl, kl, addgridvelocities, nbocos&
