...
!   with respect to varying inputs: x y
  ...
  function getcorrectfork()
    use constants
    use flowvarrefstateiff, only : kpresent
...
!
    use constants
    use blockpointersiff, only : w, p, rlv, rev, gamma, x, d2wall, si,&
...
&   iend, jstart, jend, isize, jsize
    use inputphysicsiff, only : cpmodel, equations
    implicit none
! subroutine arguments.
...
!                                                      *
    use constants
    use inputphysicsiff, only : lengthref, pointref, pointrefec, &
&   liftindex
    implicit none
