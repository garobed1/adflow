...
!   rw status of diff variables: *x:incr *vol:in-out
...
&                 , vp1, vp1d)
          ...
          xd(i, m, k, 3) = xd(i, m, k, 3) + tempd
          xd(i, m, n, 3) = xd(i, m, n, 3) + tempd
          xd(i, j, n, 3) = xd(i, j, n, 3) + tempd
          xd(l, j, k, 3) = xd(l, j, k, 3) + tempd
          xd(l, m, k, 3) = xd(l, m, k, 3) + tempd
          xd(l, m, n, 3) = xd(l, m, n, 3) + tempd
          xd(l, j, n, 3) = xd(l, j, n, 3) + tempd
          call popreal8(yp)
          tempd = eighth*ypd
          xd(i, j, k, 2) = xd(i, j, k, 2) + tempd
          xd(i, m, k, 2) = xd(i, m, k, 2) + tempd
          xd(i, m, n, 2) = xd(i, m, n, 2) + tempd
          xd(i, j, n, 2) = xd(i, j, n, 2) + tempd
          xd(l, j, k, 2) = xd(l, j, k, 2) + tempd
          xd(l, m, k, 2) = xd(l, m, k, 2) + tempd
          xd(l, m, n, 2) = xd(l, m, n, 2) + tempd
          xd(l, j, n, 2) = xd(l, j, n, 2) + tempd
          call popreal8(xp)
          tempd = eighth*xpd
          xd(i, j, k, 1) = xd(i, j, k, 1) + tempd
          xd(i, m, k, 1) = xd(i, m, k, 1) + tempd
          xd(i, m, n, 1) = xd(i, m, n, 1) + tempd
          xd(i, j, n, 1) = xd(i, j, n, 1) + tempd
          xd(l, j, k, 1) = xd(l, j, k, 1) + tempd
          xd(l, m, k, 1) = xd(l, m, k, 1) + tempd
          xd(l, m, n, 1) = xd(l, m, n, 1) + tempd
          xd(l, j, n, 1) = xd(l, j, n, 1) + tempd
        end do
        call popinteger4(m)
      end do
      call popinteger4(n)
...
!
      ...
      zbd = zbd + tempd6 + (ya-yc)*tempd1 - (xa-xc)*tempd4
      zcd = zcd + tempd6 + (yb-yd)*tempd1 - (xb-xd)*tempd4
      ...
      xpd = xpd + tempd
      tempd0 = -(fourth*tempd)
      xad = xad + (yb-yd)*tempd7 + tempd0 - (zb-zd)*tempd4
      xcd = xcd + (zb-zd)*tempd4 - (yb-yd)*tempd7 + tempd0
      xbd = xbd + (za-zc)*tempd4 - (ya-yc)*tempd7 + tempd0
      xdd = xdd + (ya-yc)*tempd7 + tempd0 - (za-zc)*tempd4
...
! diagonal vectors times fact; remember that fact is
! either -0.5 or 0.5.
      tempd = fact*skd(i, j, k, 3)
      skd(i, j, k, 3) = 0.0_8
      v1d(1) = v1d(1) + v2(2)*tempd
      v2d(2) = v2d(2) + v1(1)*tempd
      v1d(2) = v1d(2) - v2(1)*tempd
      v2d(1) = v2d(1) - v1(2)*tempd
      tempd = fact*skd(i, j, k, 2)
      skd(i, j, k, 2) = 0.0_8
      v1d(3) = v1d(3) + v2(1)*tempd
      v2d(1) = v2d(1) + v1(3)*tempd
      v1d(1) = v1d(1) - v2(3)*tempd
      v2d(3) = v2d(3) - v1(1)*tempd
      tempd = fact*skd(i, j, k, 1)
      skd(i, j, k, 1) = 0.0_8
      v1d(2) = v1d(2) + v2(3)*tempd
      v2d(3) = v2d(3) + v1(2)*tempd
      v1d(3) = v1d(3) - v2(2)*tempd
      v2d(2) = v2d(2) - v1(3)*tempd
...
! diagonal vectors times fact; remember that fact is
! either -0.5 or 0.5.
      tempd = fact*sjd(i, j, k, 3)
      sjd(i, j, k, 3) = 0.0_8
      v1d(1) = v1d(1) + v2(2)*tempd
      v2d(2) = v2d(2) + v1(1)*tempd
      v1d(2) = v1d(2) - v2(1)*tempd
      v2d(1) = v2d(1) - v1(2)*tempd
      tempd = fact*sjd(i, j, k, 2)
      sjd(i, j, k, 2) = 0.0_8
      v1d(3) = v1d(3) + v2(1)*tempd
      v2d(1) = v2d(1) + v1(3)*tempd
      v1d(1) = v1d(1) - v2(3)*tempd
      v2d(3) = v2d(3) - v1(1)*tempd
      tempd = fact*sjd(i, j, k, 1)
      sjd(i, j, k, 1) = 0.0_8
      v1d(2) = v1d(2) + v2(3)*tempd
      v2d(3) = v2d(3) + v1(2)*tempd
      v1d(3) = v1d(3) - v2(2)*tempd
...
! either -0.5 or 0.5.
      ...
      v1d(2) = v1d(2) - v2(1)*tempd
      v2d(1) = v2d(1) - v1(2)*tempd
      tempd = fact*sid(i, j, k, 2)
      sid(i, j, k, 2) = 0.0_8
      v1d(3) = v1d(3) + v2(1)*tempd
      v2d(1) = v2d(1) + v1(3)*tempd
      v1d(1) = v1d(1) - v2(3)*tempd
      v2d(3) = v2d(3) - v1(1)*tempd
      tempd = fact*sid(i, j, k, 1)
      sid(i, j, k, 1) = 0.0_8
      v1d(2) = v1d(2) + v2(3)*tempd
      v2d(3) = v2d(3) + v1(2)*tempd
      v1d(3) = v1d(3) - v2(2)*tempd
      ...
      if (branch .lt. 4) then
        if (branch .lt. 2) then
          ...
          do j=ad_to10,ad_from10,-1
            ...
            do i=ad_to9,ad_from9,-1
              tmpd16 = xd(i, j, ke, 3)
              xd(i, j, ke, 3) = 0.0_8
              xd(i, j, nz, 3) = xd(i, j, nz, 3) + tmpd16
              tmpd15 = xd(i, j, ke, 2)
              xd(i, j, ke, 2) = 0.0_8
              xd(i, j, nz, 2) = xd(i, j, nz, 2) + tmpd15
              tmpd14 = xd(i, j, ke, 1)
              dotd = norm(3)*tmpd16 + norm(2)*tmpd15 + norm(1)*tmpd14
              xd(i, j, ke, 1) = 0.0_8
              xd(i, j, nz, 1) = xd(i, j, nz, 1) + tmpd14
              tempd = two*dotd
        ...
        if (branch .eq. 4) then
          ...
          do j=ad_to6,ad_from6,-1
            ...
            do i=ad_to5,ad_from5,-1
              tmpd13 = xd(i, je, j, 3)
              xd(i, je, j, 3) = 0.0_8
              xd(i, ny, j, 3) = xd(i, ny, j, 3) + tmpd13
              tmpd12 = xd(i, je, j, 2)
              xd(i, je, j, 2) = 0.0_8
              xd(i, ny, j, 2) = xd(i, ny, j, 2) + tmpd12
              tmpd11 = xd(i, je, j, 1)
              dotd = norm(3)*tmpd13 + norm(2)*tmpd12 + norm(1)*tmpd11
              xd(i, je, j, 1) = 0.0_8
              xd(i, ny, j, 1) = xd(i, ny, j, 1) + tmpd11
              tempd = two*dotd
              v1d(1) = v1d(1) + norm(1)*tempd
              v1d(2) = v1d(2) + norm(2)*tempd
              v1d(3) = v1d(3) + norm(3)*tempd
        ...
        do j=ad_to2,ad_from2,-1
          ...
          do i=ad_to1,ad_from1,-1
            tmpd10 = xd(ie, i, j, 3)
            xd(ie, i, j, 3) = 0.0_8
            xd(nx, i, j, 3) = xd(nx, i, j, 3) + tmpd10
            tmpd9 = xd(ie, i, j, 2)
            xd(ie, i, j, 2) = 0.0_8
            xd(nx, i, j, 2) = xd(nx, i, j, 2) + tmpd9
            tmpd8 = xd(ie, i, j, 1)
            dotd = norm(3)*tmpd10 + norm(2)*tmpd9 + norm(1)*tmpd8
            xd(ie, i, j, 1) = 0.0_8
            xd(nx, i, j, 1) = xd(nx, i, j, 1) + tmpd8
            tempd = two*dotd
            v1d(1) = v1d(1) + norm(1)*tempd
            v1d(2) = v1d(2) + norm(2)*tempd
            v1d(3) = v1d(3) + norm(3)*tempd
 ...
 100 continue
    do j=je,0,-1
      do i=ie,0,-1
        tmpd7 = xd(i, j, ke, 3)
        xd(i, j, ke, 3) = 0.0_8
        xd(i, j, kl, 3) = xd(i, j, kl, 3) + two*tmpd7
        xd(i, j, nz, 3) = xd(i, j, nz, 3) - tmpd7
        tmpd6 = xd(i, j, ke, 2)
        xd(i, j, ke, 2) = 0.0_8
        ...
        tmpd5 = xd(i, j, ke, 1)
        xd(i, j, ke, 1) = 0.0_8
        xd(i, j, kl, 1) = xd(i, j, kl, 1) + two*tmpd5
        xd(i, j, nz, 1) = xd(i, j, nz, 1) - tmpd5
    ...
    do k=kl,1,-1
      do i=ie,0,-1
        tmpd4 = xd(i, je, k, 3)
        xd(i, je, k, 3) = 0.0_8
        xd(i, jl, k, 3) = xd(i, jl, k, 3) + two*tmpd4
        xd(i, ny, k, 3) = xd(i, ny, k, 3) - tmpd4
        tmpd3 = xd(i, je, k, 2)
        xd(i, je, k, 2) = 0.0_8
        ...
        tmpd2 = xd(i, je, k, 1)
        xd(i, je, k, 1) = 0.0_8
        xd(i, jl, k, 1) = xd(i, jl, k, 1) + two*tmpd2
        xd(i, ny, k, 1) = xd(i, ny, k, 1) - tmpd2
    ...
    do k=kl,1,-1
      do j=jl,1,-1
        tmpd1 = xd(ie, j, k, 3)
        xd(ie, j, k, 3) = 0.0_8
        xd(il, j, k, 3) = xd(il, j, k, 3) + two*tmpd1
        xd(nx, j, k, 3) = xd(nx, j, k, 3) - tmpd1
        tmpd0 = xd(ie, j, k, 2)
        xd(ie, j, k, 2) = 0.0_8
        ...
        tmpd = xd(ie, j, k, 1)
        xd(ie, j, k, 1) = 0.0_8
        xd(il, j, k, 1) = xd(il, j, k, 1) + two*tmpd
        xd(nx, j, k, 1) = xd(nx, j, k, 1) - tmpd
...
!   plus diff mem management of: dw:in
  subroutine resscale_b()
    use constants
    use blockpointers_diff, only : il, jl, kl, nx, ny, nz, volref, dw, &
&   dwd
    use flowvarrefstate_diff, only : nwf, nt1, nt2
...
!   plus diff mem management of: dw:in fw:in
  subroutine sumdwandfw_b()
    use constants
    use blockpointers_diff, only : il, jl, kl, dw, dwd, fw, fwd, iblank
    use flowvarrefstate_diff, only : nwf
    implicit none
! local variables
  ...
  subroutine sumdwandfw()
    use constants
    use blockpointers_diff, only : il, jl, kl, dw, fw, iblank
    use flowvarrefstate_diff, only : nwf
    implicit none
! local variables
    integer(kind=inttype) :: i, j, k, l
