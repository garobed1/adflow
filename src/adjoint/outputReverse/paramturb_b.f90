...
contains
!  differentiation of saassign in reverse (adjoint) mode (with options i4 dr8 r8 noisize):
!   gradient     of useful results: rsak rsacv1 rsacw1 rsacw2 rsacw3
!                rsact3 rsact4 rsacrot rsacb1 rsacb2 rsacb3
!   with respect to varying inputs: saconsts
!reassign sa constants
  subroutine saassign_b()
    implicit none
    ...
    rsacb3 = saconsts(4)
    saconstsd0 = 0.0_8
    saconstsd0(12) = saconstsd0(12) + rsacrotd
    saconstsd0(11) = saconstsd0(11) + rsact4d
    saconstsd0(10) = saconstsd0(10) + rsact3d
    saconstsd0(7) = saconstsd0(7) + rsacw3d
    saconstsd0(6) = saconstsd0(6) + rsacw2d
    tempd = rsacw1d/rsak**2
    rsacb1d = rsacb1d + tempd
    rsakd = rsakd - rsacb1*2*tempd/rsak
    rsacb2d = rsacb2d + rsacw1d/rsacb3
    rsacb3d = rsacb3d - (rsacb2+1.)*rsacw1d/rsacb3**2
    saconstsd0(5) = saconstsd0(5) + rsacv1d
    saconstsd0(4) = saconstsd0(4) + rsacb3d
    saconstsd0(3) = saconstsd0(3) + rsacb2d
    saconstsd0(2) = saconstsd0(2) + rsacb1d
    saconstsd0(1) = saconstsd0(1) + rsakd
  end subroutine saassign_b
!reassign sa constants
  subroutine saassign()
    implicit none
    rsak = saconsts(1)
