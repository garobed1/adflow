      ...
      case (imax) 
        ...
        do j=bcdata(nn)%jcend,bcdata(nn)%jcbeg,-1
          do i=bcdata(nn)%icend,bcdata(nn)%icbeg,-1
            ...
            tempd = two*60.0_realtype*bvti2d(i, j, itu2)
...
&             , jj)*rkwbeta1*one*tmpdd/temp**2
            temp = w(il, i, j, irho)
            rlvd(jl, i, j) = rlvd(jl, i, j) + nud/temp
      ...
      case (jmin) 
        ...
        do j=bcdata(nn)%jcend,bcdata(nn)%jcbeg,-1
          do i=bcdata(nn)%icend,bcdata(nn)%icbeg,-1
            ...
            tempd = two*60.0_realtype*bvtj1d(i, j, itu2)
...
&             )*rkwbeta1*one*tmpdd/temp**2
            temp = w(i, 2, j, irho)
            rlvd(i, 2, j) = rlvd(i, 2, j) + nud/temp
      ...
      case (jmax) 
        ...
        do j=bcdata(nn)%jcend,bcdata(nn)%jcbeg,-1
          do i=bcdata(nn)%icend,bcdata(nn)%icbeg,-1
            ...
            tempd = two*60.0_realtype*bvtj2d(i, j, itu2)
...
&             , jj)*rkwbeta1*one*tmpdd/temp**2
            temp = w(i, jl, j, irho)
            rlvd(i, jl, j) = rlvd(i, jl, j) + nud/temp
      ...
      case (kmin) 
        ...
        do j=bcdata(nn)%jcend,bcdata(nn)%jcbeg,-1
          do i=bcdata(nn)%icend,bcdata(nn)%icbeg,-1
            ...
            tempd = two*60.0_realtype*bvtk1d(i, j, itu2)
...
&             )*rkwbeta1*one*tmpdd/temp**2
            temp = w(i, j, 2, irho)
            rlvd(i, j, 2) = rlvd(i, j, 2) + nud/temp
      ...
      case (kmax) 
        ...
        do j=bcdata(nn)%jcend,bcdata(nn)%jcbeg,-1
          do i=bcdata(nn)%icend,bcdata(nn)%icbeg,-1
            ...
            tempd = two*60.0_realtype*bvtk2d(i, j, itu2)
...
&             , kl)*rkwbeta1*one*tmpdd/temp**2
            temp = w(i, j, kl, irho)
            rlvd(i, j, kl) = rlvd(i, j, kl) + nud/temp
