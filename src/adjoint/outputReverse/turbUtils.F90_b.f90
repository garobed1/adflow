...
!
    use constants
    use blockpointers_diff, only : nx, ny, nz, il, jl, kl, w, si, sj, sk&
...
!
    use constants
    use blockpointers_diff, only : nx, ny, nz, il, jl, kl, vol, vold, &
...
!
    use constants
    use blockpointers_diff, only : nx, ny, nz, il, jl, kl, vol, sfacei, &
