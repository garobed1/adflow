...
!
  ...
  use inputphysics_diff, only : saconsts, saconstsd
  implicit none
  save 
!
...
!reassign sa constants
  subroutine saassign_b()
    ...
    rsacb3 = saconsts(4)
    saconstsd = 0.0_8
    saconstsd(12) = saconstsd(12) + rsacrotd
    saconstsd(11) = saconstsd(11) + rsact4d
    saconstsd(10) = saconstsd(10) + rsact3d
    saconstsd(7) = saconstsd(7) + rsacw3d
    saconstsd(6) = saconstsd(6) + rsacw2d
    tempd = rsacw1d/rsak**2
    rsacb2d = rsacb2d + rsacw1d/rsacb3
    rsacb3d = rsacb3d - (rsacb2+1.)*rsacw1d/rsacb3**2
    rsacb1d = rsacb1d + tempd
    rsakd = rsakd - 2*rsacb1*tempd/rsak
    saconstsd(5) = saconstsd(5) + rsacv1d
    saconstsd(4) = saconstsd(4) + rsacb3d
    saconstsd(3) = saconstsd(3) + rsacb2d
    saconstsd(2) = saconstsd(2) + rsacb1d
    saconstsd(1) = saconstsd(1) + rsakd
