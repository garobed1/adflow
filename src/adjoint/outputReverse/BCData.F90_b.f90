...
! bcdata.
  ...
  subroutine setbcvarnamessubsonicinflow()
    use constants
    use cgnsnames
    use inputphysics_diff, only : equations
    use flowvarrefstate_diff, only : nwt
    implicit none
!
!      local variables.
!
...
!
    use constants
    use cgnsnames
    use inputphysics_diff, only : equations, turbmodel
    implicit none
!
...
!
    ...
    use inputphysics_diff, only : cpmodel, gammaconstant, rgasdim
    use flowvarrefstate_diff, only : pinfdim, pinfdimd
    implicit none
!
!      subroutine arguments.
!
...
!
    ...
    use communication, only : myid
    use inputphysics_diff, only : cpmodel, gammaconstant, rgasdim
    use flowvarrefstate_diff, only : pinfdim
    implicit none
!
!      subroutine arguments.
!
...
!
    use constants
    use blockpointers_diff, only : bcfaceid, bcdata, x, si, sj, sk, il, &
&   jl, kl, sectionid
...
!
    use constants
    use cgnsnames
    use blockpointers_diff, only : bcfaceid, bcdata, bcdatad, nbkglobal
    use utils_diff, only : terminate, sitemperature
    use flowvarrefstate_diff, only : tref, trefd
    implicit none
!
!      subroutine arguments.
!
...
!
    use constants
    use cgnsnames
    use blockpointers_diff, only : bcfaceid, bcdata, nbkglobal
    use utils_diff, only : terminate, sitemperature
    use flowvarrefstate_diff, only : tref
    implicit none
!
!      subroutine arguments.
!
...
!
    use constants
    use cgnsnames
    use blockpointers_diff, only : nbkglobal, sectionid, bcfaceid, &
&   bcdata, bcdatad
    use flowvarrefstate_diff, only : tref, trefd, pref, prefd, href, &
...
!
      ...
      use inputphysics_diff, only : rgasdim
      use section, only : sections
      implicit none
!
!        local variables.
...
!
    ...
    use blockpointers_diff, only : nbkglobal, sectionid, bcfaceid, &
&   bcdata
    use flowvarrefstate_diff, only : tref, pref, href, rhoref, muref, &
&   nwt, winf
    use inputphysics_diff, only : equations
    use utils_diff, only : sidensity, sivelocity, sipressure, siangle, &
&   sitemperature, terminate
...
!
    use constants
    use cgnsnames
    use blockpointers_diff, only : bcdata, bcdatad, nbkglobal, bcfaceid
    use utils_diff, only : terminate, sipressure
    use flowvarrefstate_diff, only : pref, prefd
    implicit none
!
!      subroutine arguments.
!
...
!
    use constants
    use cgnsnames
    use blockpointers_diff, only : bcdata, nbkglobal, bcfaceid
    use utils_diff, only : terminate, sipressure
    use flowvarrefstate_diff, only : pref
    implicit none
!
!      subroutine arguments.
!
...
!
    ...
    use blockpointers_diff, only : bcdata, bcdatad, nbkglobal, bcfaceid,&
&   sectionid
    use flowvarrefstate_diff, only : nwt, pinfcorr, pinfcorrd, winf, &
&   winfd, uref, urefd, rhoref, rhorefd, pref, prefd, muref, murefd
    use inputphysics_diff, only : equations, flowtype, veldirfreestream,&
&   veldirfreestreamd
...
!
    ...
    use blockpointers_diff, only : bcdata, nbkglobal, bcfaceid, &
&   sectionid
    use flowvarrefstate_diff, only : nwt, pinfcorr, winf, uref, rhoref, &
&   pref, muref
    use inputphysics_diff, only : equations, flowtype, veldirfreestream
    use utils_diff, only : sidensity, sipressure, sivelocity, &
&   sitemperature, terminate
...
!
    use constants
    use flowvarrefstate_diff, only : nt1, nt2, muref, murefd, pref, &
...
!
    use constants
    use flowvarrefstate_diff, only : nt1, nt2, muref, pref, rhoref, winf
    use inputphysics_diff, only : equations, turbmodel
    use utils_diff, only : terminate, siturb
    implicit none
!
