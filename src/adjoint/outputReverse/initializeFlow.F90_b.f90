...
!
    use constants
    use paramturb_diff
    use inputphysics_diff, only : equations, mach, machd, machcoef, &
...
&   rgasdim, ssuthdim, eddyvisinfratio, turbmodel, turbintensityinf
    use flowvarrefstate_diff, only : pinfdim, pinfdimd, tinfdim, &
...
&   winfd, nw, nwf, kpresent, winf, winfd
    use flowutils_diff, only : computegamma, etot, etot_b
    use turbutils_diff, only : sanuknowneddyratio, sanuknowneddyratio_b
    implicit none
...
!
    use constants
    use paramturb_diff
    use inputphysics_diff, only : equations, mach, machcoef, musuthdim, &
&   tsuthdim, veldirfreestream, rgasdim, ssuthdim, eddyvisinfratio, &
&   turbmodel, turbintensityinf
    use flowvarrefstate_diff, only : pinfdim, tinfdim, rhoinfdim, &
